    ...
    def create_receipt(self, payload: PurchaseReceiptCreate) -> PurchaseReceipt:
        ...
        try:
            ...
            for item_data in payload.items:
                ...
                new_received = Decimal(order_item.quantity_received or 0) + \
                               Decimal(item_data.quantity_received)
                ...
                # Add to total
                total_receipt += Decimal(item_data.quantity_received) * \
                                 Decimal(item_data.cost_price)
